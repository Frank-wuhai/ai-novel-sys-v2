...
def main() -> int:
    ...
    with session_scope() as session:
        ...
        if book2_ch1:
            ...
            if plan.next_action not in {"approve_chapter", "reading_assessment_review", "record_chapter_continuity", "draft_chapter", "revise_chapter"}:
            ...
            if active_revision:
                if plan.next_action not in {"revise_chapter", "reading_assessment_review"}:
