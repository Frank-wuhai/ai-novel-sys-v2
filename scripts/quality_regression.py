...
def _quality_fixture_chapter(chapter_number: int) -> str:
    unit = (
        ...
        "雨水顺着门槛往里爬，纸角被泡得发软，仍能看见梅家旧印的一点朱色。"
        "他没有立刻冲进去，而是把袖口的锈铜铃按住，低声问：“昨夜谁来过？别说没有，碗沿的血还没干。”"
        "掌柜把药碗往前一推，声音发哑：“你若真想问，就先把门外那几个人打发走。老夫的铺子小，经不起第二回搜。”"
        "陈默听见门外铁尺敲在青石上的声响，先用脚尖把账纸压回阴影里，又故意笑了一声："
        "“铁尺馆查案，什么时候要靠翻药铺的药渣了？”"
        "领头弟子果然停步，斜眼看他：“你认识这印？”"
        "陈默没有答死，只把半碗热药端起来闻了闻：“像梅家，也像有人故意让你们以为是梅家。”"
        "这句话换来三息空隙，也换来掌柜在欠账簿上添下他的名字。"
        "他必须在交出账纸和保住伤者之间选一条路，最后只拿走账纸背面那一小块湿印，留下正面给铁尺馆搜。"
        "代价落地时，掌柜压低声音说：“陈少侠，今日之后，你也在这本账里了。”"
        "陈默手心微凉，袖中的锈铜铃忽然发冷，账纸背面浮出一个他刚刚听过的名字。"
    )
    return "\n".join([unit] * 9)
