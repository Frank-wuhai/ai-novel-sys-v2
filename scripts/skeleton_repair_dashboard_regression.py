...
from app.models.entities import MarketSignal, PlatformFeedback, StoryFoundation
...
TEST_DB = "sqlite:///data/skeleton-repair-dashboard-regression.db"
...
def main() -> int:
    ...
    with session_scope() as session:
        applied = _perform_action(
            session,
            {"action": "apply_story_skeleton_repair", "book_id": book_id, "current_skeleton": BAD_SKELETON},
        )
