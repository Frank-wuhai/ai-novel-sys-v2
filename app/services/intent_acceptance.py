...
CONCEPT_ALIASES = (
    (("真实武侠", "武侠世界", "活的江湖"), ("江湖", "门派", "梅家", "断魂崖", "铁杖", "账册", "轻功")),
    ...
    (("冒险", "破局", "保命"), ("保命", "跪", "铁杖", "追兵", "站直", "主动", "开口", "喉前")),
    (("梅引", "梅引代价"), ("梅引", "梅霜", "账册", "梅家", "旧债", "追兵", "托孤", "油布包")),
    (("武侠套路", "套路触发器", "论坛热梗", "经典桥段"), ("套路", "桥段", "论坛", "热梗", "梅引", "经典", "触发")),
    (("试探套路触发器", "试探", "触发器"), ("跪", "前辈", "江湖笑容", "送人", "经典", "桥段", "主动")),
    (("门派恩怨", "门派", "恩怨", "真实动机"), ("门派", "恩怨", "梅家", "旧债", "账册", "守谷", "追兵", "恨意")),
    (("人情", "人物关系", "新关系"), ("人情", "欠", "债", "账册", "托孤", "梅霜", "老妇")),
    (("代价", "后果", "承担"), ("代价", "后果", "痛", "疼", "血", "欠", "三日不能动气", "旧债", "追兵")),
    (("追兵", "危险", "压力", "外部压力"), ("追兵", "脚步", "火把", "危险", "铁杖", "喉前", "裂缝", "杀气")),
    (("章末", "钩子", "新机会", "新危险"), ("追兵", "铜铃", "内谷", "旧债", "黑暗", "更近", "门外", "机会", "危险")),
    (("沈青梧", "托孤者", "守洞人", "守谷人"), ("沈青梧", "梅霜", "老妇", "守谷人", "守洞人", "老人", "铁杖")),
)
...
def _negative_point_satisfied(content: str, point: str) -> bool:
    negative_markers = ("禁止", "不得", "不能", "不要", "不是", "不靠", "不能靠")
