...
- 如果本书采用“现实同步”机制，不能只是“实力同步到现实”，必须写清同步对象、阈值、延迟、副作用、被科技世界观测到的方式；如果 Story Bible 要求游戏/异世界与现实隔离，则严禁设计任何能力、修为、伤势或收益外溢现实。
...
- 每套创意发动机必须提供一个“反俗套失败场景”：失败不是有人来抓他，而是主角因为错误复刻、过度贴合经典桥段、临场改词、替别人承担因果、在本书规则允许的边界内造成一件尴尬、可笑、疼痛、关系变形或收益污染的具体事件；若 Story Bible 要求现实隔离，不得把游戏动作带回现实。
...
- 失败场景必须来自主角可理解但错误的选择：错误复刻、过度贴合桥段、临场改词、替别人承因果、规则误用、奖励延迟、好感错账、现实生活失衡；若 Story Bible 允许现实同步，才可使用游戏动作外溢现实，否则严禁。
